...
def Hill48(sig_XX, sig_YY):
	F=0.64255
	G=0.62171
	H=0.401439
	sig_0=355
	return H*(sig_XX-sig_YY)**2+G*sig_XX**2+F*sig_YY**2-sig_0**2
...
def htpp_plot_yieldlocus(odb_name,option,pdf,size,table):
	...
	for s12 in shear:
		...
		plt.plot(yldlocus[:,3],yldlocus[:,4],'.',color=(0,0.3,0.85,1.0), lw=1.5,zorder=100,rasterized=True)
